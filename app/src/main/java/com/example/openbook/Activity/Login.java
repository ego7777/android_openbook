    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.d(TAG, "onClick id: " + id.hashCode());
                Log.d(TAG, "onClick password: " + password.hashCode());
                ...
                if (!id.isEmpty() && !password.isEmpty()) {
                    ...
                    call.enqueue(new Callback<LoginResponseModel>() {
                        ...
                        public void onResponse(Call<LoginResponseModel> call, Response<LoginResponseModel> response) {
                            if (response.isSuccessful()) {
                                Log.d(TAG, "onResponse Login result: " + response.body().getResult());
                                Log.d(TAG, "onResponse Login id: " + response.body().getId());
                    ...
                    dialogCustom.showAlertDialog(Login.this, "아이디와 패스워드를 모두 입력해주세요.");
                }
            }
        });
                ...
                checkIdCall.enqueue(new Callback<SuccessOrNot>() {
                    ...
                    public void onResponse(Call<SuccessOrNot> call, Response<SuccessOrNot> response) {
                        if(response.isSuccessful()){
                            ...
                            Toast.makeText(Login.this, "네트워크 문제", Toast.LENGTH_SHORT).show();
                        }
                    }
